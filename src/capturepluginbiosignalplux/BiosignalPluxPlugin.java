...
public class BiosignalPluxPlugin implements CaptureProvider{

    List<Configuration> configurations;

    private static final Logger logger = Logger.getLogger(BiosignalPluxPlugin.class.getName());
    private BiosignalPluxCaptureConfigurationDialog dialog;

    public BiosignalPluxPlugin() {
    ...
    public StagePlugin fromFile(File file) {
        if (file.isFile()) {
            try {
                BiosignalPluxPlugin mc = new BiosignalPluxPlugin();
