 ...
 * the License.
 */
package com.biosignalplux.comm;
 ...
 */
public enum BiosignalPluxErrorTypes {
    ...
    private static Map<Integer, BiosignalPluxErrorTypes> map = new HashMap<Integer, BiosignalPluxErrorTypes>();

    static {
        for (BiosignalPluxErrorTypes error : BiosignalPluxErrorTypes.values())
    ...
    private BiosignalPluxErrorTypes(final int value, final String description) {
        this.value = value;
     ...
     *
     * @param value a int.
     * @return a {@link com.biosignalplux.comm.BiosignalPluxErrorTypes} object.
     */
    public static BiosignalPluxErrorTypes fromValue(final int value) {
